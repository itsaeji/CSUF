...
namespace TEST_3
{
    ...
    /// </summary>
    public sealed partial class DessertMenu : Page
    {
        ...
        private void FoodItem_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            FoodItem newItem = new FoodItem() { foodName = foodButton.foodName, cost = Math.Round(foodButton.cost, 2), foodType = "Dessert" };
